...
def update(idTarefa):
    if request.method == "POST":
        ...
        if titulo and data:
            tarefa = Tarefa(
                titulo_tarefa=titulo, data_conclusao=data, id_tarefa=idTarefa
            )
...
# Este arquivo é o controlador da aplicação.
# Ele define as rotas do Flask, recebe os dados dos formulários, usa a classe Tarefa para acessar o banco de dados e envia as informações para os templates HTML.
# Também cria a tabela no SQLite e inicia o servidor da aplicação.
