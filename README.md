...
Este projeto foi elaborado para permitir o aprendizado de conceitos como o padrão de projeto MVC (Model-View-Controller), framework Flask e seus componentes, variáveis de ambiente, paradigma de programação  orientado a objetos  reforço de fundamentos da linguagem de programação Python.
...
7. Copie o arquivo `.env.example`, cole na raiz do projeto e renomeie esse arquivo para `.env`.
